...
import it.gianni.numberschecker.mapper.IEntityOmMapper;
...
public class CSVService implements ICSVService {
    ...
    private final IEntityOmMapper mapper;

    public CSVService(SouthAfricanMobileNumberRepository repository, IValidateNumberService validateNumberService, IEntityOmMapper mapper) {
